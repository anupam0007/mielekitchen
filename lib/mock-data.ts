...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    name: "Berry Tart",
    category: "Tarts",
    description: "Buttery tart shell filled with white chocolate berry ganache.",
    image: "/menu/strawberry-tart.jpg",
    gradient: ["#f8e9e4", "#e8b7ac"],
  },
  {
    id: "chocolate-marble-tart",
    slug: "choco-peanut-tart",
    name: "Choco Peanut Tart",
    category: "Tarts",
    description: "Buttery tart shell filled with a chocolate ganache and Peanutbutter.",
  ...
  },
  {
    ...
    name: "Rum Tart",
    category: "Tarts",
    description: "Buttery tart shell filled with a rich rum-infused dark chocolate.",
